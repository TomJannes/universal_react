...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateLocation = __webpack_require__(3);
	...
	var _altInstance = __webpack_require__(153);

	var _altInstance2 = _interopRequireDefault(_altInstance);

	var _routesJsx = __webpack_require__(155);

	var _routesJsx2 = _interopRequireDefault(_routesJsx);

	var _baseHtml = __webpack_require__(163);

	var _baseHtml2 = _interopRequireDefault(_baseHtml);

	var renderToMarkup = function renderToMarkup(alt, state, req, res, cb) {

	    alt.bootstrap(state);
	    var location = (0, _historyLibCreateLocation2['default'])(req.url);
	    (0, _reactRouter.match)({ routes: _routesJsx2['default'], location: location }, function (error, redirectLocation, renderProps) {
	        if (redirectLocation) {
	            ...
	            var content = (0, _reactDomServer.renderToString)(_react2['default'].createElement(_reactRouter.RoutingContext, renderProps));
	            var markup = _iso2['default'].render(content, alt.flush());
	            cb(_baseHtml2['default'].replace('CONTENT', markup));
	        }
	    });
	};

	function render(state, req, res, cb) {
	    renderToMarkup(_altInstance2['default'], state, req, res, cb);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isTextInputElement = __webpack_require__(42);
	var keyOf = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsApp = __webpack_require__(156);

	var _componentsApp2 = _interopRequireDefault(_componentsApp);

	var _componentsHello = __webpack_require__(161);

	var _componentsHello2 = _interopRequireDefault(_componentsHello);

	var _componentsTest = __webpack_require__(162);
	...
	exports['default'] = _react2['default'].createElement(
	  ...
	  _react2['default'].createElement(_reactRouter.Route, { path: '/', component: _componentsHello2['default'] }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _altAltContainer = __webpack_require__(157);

	var _altAltContainer2 = _interopRequireDefault(_altAltContainer);

	var _storesUserStore = __webpack_require__(158);
	        ...
	        */
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                { stores: {
	                        UserStore: _storesUserStore2['default']
	                    } },
...
/***/ function(module, exports) {
	...
	module.exports = require("alt/AltContainer");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsUserActions = __webpack_require__(159);
